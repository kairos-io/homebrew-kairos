class KairosLab < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/kairos-io/kairos-lab/releases/download/v#{version}/kairos-lab_#{version}_darwin_arm64.tar.gz"
  ...
  on_linux do
    on_intel do
      url "https://github.com/kairos-io/kairos-lab/releases/download/v#{version}/kairos-lab_#{version}_linux_amd64.tar.gz"
      sha256 "cddfe22a70d5d76ac508711a495053fc460d929546f27ca7da43b56658a61772"
    end

    on_arm do
      url "https://github.com/kairos-io/kairos-lab/releases/download/v#{version}/kairos-lab_#{version}_linux_arm64.tar.gz"
